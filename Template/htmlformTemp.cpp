...
//---------------------------------------------------------------------------
ThtmlformTemp::~ThtmlformTemp(void)
{
...
//---------------------------------------------------------------------------
TColor ThtmlformTemp::MapColor(AnsiString strColor)
{
    int i;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::Analyse(AnsiString& strCaption)
{
...
//---------------------------------------------------------------------------
void ThtmlformTemp::AnalyseName(AnsiString& strCaption)
{
    ControlInfo * pControlInfo;
    AnsiString strText,strButtonCaption,strColor,strInitialText,strControlName,strSubCaption;
    AnsiString strType;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::ExtAnalyseName(AnsiString& strCaption)
{
    ControlInfo * pControlInfo;
    AnsiString strText,strButtonCaption,strColor,strInitialText,strControlName,strSubCaption;
    AnsiString strType;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::InitGlobalFont(void)
{
    m_FontStyles.Clear();
    ...
    m_pGlobalFont->Pitch   = TFontPitch::fpDefault;
    m_pGlobalFont->Style   = m_FontStyles;
}
//---------------------------------------------------------------------------
void ThtmlformTemp::FilterString(AnsiString& strCaption)
//过滤
{
	int nPos;
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::OpenTemplate(TScrollingWinControl * AParent,AnsiString Template)
{
    FILE * pStream;
    char szLine[MAXSIZE];
...
//---------------------------------------------------------------------------
/*
bool ThtmlformTemp::OpenTemplate(AnsiString Template)
{
    FILE * pStream;
    char szLine[MAXSIZE];
    AnsiString strLine,strCaption,strColor;
...
*/
//---------------------------------------------------------------------------
bool ThtmlformTemp::ExtOpenTemplate(AnsiString Template)
{
    FILE * pStream;
    char szLine[MAXSIZE];
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::OpenTemplate(TScrollingWinControl * AParent,
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::SaveTemplate(AnsiString TemplatePath)
{
    try
    {
...
//---------------------------------------------------------------------------
void ThtmlformTemp::ShowControls()
{
	ControlInfo * pNode;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::CloseTemplate()
{
	ControlInfo * pParentNode,* pNode;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::ClearTemplate()
{
	ControlInfo * pParentNode,* pNode;
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::MatchString(AnsiString& strTarget,AnsiString strMatch)
...
//---------------------------------------------------------------------------
AnsiString ThtmlformTemp::PickupCaption(AnsiString& strCaption)
//提取Caption
{
...
//---------------------------------------------------------------------------
SIZE ThtmlformTemp::getTextExtent()
{
    SIZE FontExtent;
    TLabel * pLabel;
    TCanvas * pTempCanvas;
...
//---------------------------------------------------------------------------
AnsiString ThtmlformTemp::PickupName(AnsiString strCaption)
{
    int nPos;
...
//---------------------------------------------------------------------------
AnsiString ThtmlformTemp::SQLStr(AnsiString strText)
{
...
//---------------------------------------------------------------------------
void ThtmlformTemp::GetControlText(TInputInfo * NewValues)
{
	ControlInfo * pNode;
    TMemo * pMemo;
    AnsiString strText;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::GetControlName(TInputInfo * NewValues)
{
	ControlInfo * pNode;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::SetControlText(TInputInfo * NewValues)
{
	ControlInfo * pNode;
    TMemo * pMemo;
    TComboBox * pComboBox;
...
//---------------------------------------------------------------------------
AnsiString ThtmlformTemp::GetTimeCodeName()
{
...
//---------------------------------------------------------------------------
AnsiString ThtmlformTemp::GetImageName()
{
	AnsiString strFieldName;
	ControlInfo * pNode;
	pNode = m_pControlInfoHeader;
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::GetImage(TStream* pStream,AnsiString strFieldName)
{
/*	ControlInfo * pNode;
	pNode = m_pControlInfoHeader;
	while (pNode)
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::SetTimeCode(AnsiString strTimeCode,AnsiString strFieldName)
{
	ControlInfo * pNode;
	int i;
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::SetImage(TStream* pStream,AnsiString strFieldName)
{
	ControlInfo * pNode;
	pNode = m_pControlInfoHeader;
    while (pNode)
	{
	   if ((pNode->strClassName == "TImageEn")&&(pNode->strControlName == strFieldName))
	   {
            pStream->Position = 0;
			try{
				((TImageEn *)pNode->pControl)->IO->LoadFromStreamJpeg(pStream);
				((TImageEn *)pNode->pControl)->Proc->Resample(IMAGEWIDTH,IMAGEHEIGHT,rfNone);
			}
            catch(...)
            {
            }
...
//---------------------------------------------------------------------------
bool ThtmlformTemp::SetSingleControlText(int nIndex,char * pNewValue)
{
	ControlInfo * pNode;
    TMemo * pMemo;
    TComboBox * pComboBox;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::ClearValues(TInputInfo * NewValues)
{
	ControlInfo * pNode;
    int nCount = 0;
    char * pText;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::ClearControlText()
{
	ControlInfo * pNode;
	TMemo       * pMemo;
	TComboBox   * pComboBox;
...
//---------------------------------------------------------------------------
void ThtmlformTemp::ClearControlText(TInputInfo* pInfo)
{
	ControlInfo * pNode;
    TMemo       * pMemo;
    TComboBox   * pComboBox;
